...
class GameScene: SKScene, SKPhysicsContactDelegate{
    ...
    override func didMoveToView(view: SKView) {
        ...
        /**
        1. moving というSK NODE を生成して scene 自体に addchild してみる
        Q.
        では、moving を addChild してみて、何が起こるか？という所である
        moving は他の何に使われているのか？
        **/
        moving = SKNode()
        ...
        **/
        ...
        moveSkySprite と resetSkySprite が、どういうわけか、repeatActionForever している。
        どういうわけかは分からない
        **/
        ...
        **/
        for var i:CGFloat = 0; i < 2.0 + self.frame.size.width / ( skyTexture.size().width * 2.0 ); ++i {
            ...
            /**
            skyTexture を 延々と動かしている
            というわけで skyTexture は関係無い。
            **/
        ...
        **/
        ...
        // spawn the pipes
        /**
        using closure with spawnPipes() 何で？
        **/
        ...
        **/
        ...
        /**
        spawnThenDelayForever が何のアニメーションをしているのか？
